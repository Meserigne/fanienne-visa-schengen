...
const SECTIONS: Section[] = [
  ...
  },
  {
    fr: {
      ...
      paragraphs: [
        ...
        "Après envoi du formulaire, nous pouvons vous adresser une confirmation par e-mail et par SMS sur le numéro indiqué, via nos prestataires techniques (messagerie et SMS).",
    ...
    en: {
      ...
      paragraphs: [
        ...
        "After you submit the form, we may send a confirmation by email and SMS to the number you provide, through our technical providers (email and SMS).",
  ...
  },
  {
    ...
    en: {
      ...
      paragraphs: [
        "Access is limited to Tooky Consulting staff authorised to handle your file. Technical providers (website hosting, email, SMS, AI provider for the chat assistant) may process data only to operate our tools, under confidentiality obligations.",
