...
const SECTIONS: Section[] = [
  {
    fr: {
      ...
      paragraphs: [
        "Fanienne, cabinet d'accompagnement visa Schengen basé à Dakar (Sénégal), est responsable du traitement des données personnelles collectées via ce site et lors de nos échanges (formulaire, e-mail).",
        "Contact : contact@fanienne.sn",
      ],
    },
    en: {
      title: "1. Who is responsible?",
      paragraphs: [
        "Fanienne, a Schengen visa consultancy based in Dakar (Senegal), is responsible for personal data collected through this website and in our exchanges (form, email).",
        "Contact: contact@fanienne.sn",
      ],
    },
  },
  ...
  },
  {
    fr: {
      ...
      paragraphs: [
        ...
        "Nous ne vendons pas vos données à des tiers. Fanienne est un cabinet de conseil indépendant, sans lien avec les consulats ; la décision de visa appartient uniquement aux autorités consulaires.",
      ],
    },
    en: {
      ...
      paragraphs: [
        ...
        "We do not sell your data to third parties. Fanienne is an independent advisory firm with no affiliation to consulates; visa decisions rest solely with consular authorities.",
      ],
    },
  },
  {
  ...
  },
  {
    fr: {
      ...
      paragraphs: [
        "L'accès est limité aux personnes de Fanienne habilitées à traiter votre dossier. Des prestataires techniques (hébergement du site, messagerie) peuvent traiter des données uniquement pour faire fonctionner nos outils, dans le cadre de leurs obligations de confidentialité.",
    ...
    en: {
      ...
      paragraphs: [
        "Access is limited to Fanienne staff authorised to handle your file. Technical providers (website hosting, email) may process data only to operate our tools, under confidentiality obligations.",
  ...
  },
  {
    fr: {
      ...
      paragraphs: [
        ...
        "Pour exercer vos droits : contact@fanienne.sn. Nous répondons dans un délai raisonnable. Si vous estimez que vos droits ne sont pas respectés, vous pouvez saisir l'autorité compétente en matière de protection des données.",
      ],
    },
    en: {
      title: "7. Your rights",
      paragraphs: [
        ...
        "To exercise your rights: contact@fanienne.sn. We reply within a reasonable time. If you believe your rights are not respected, you may contact the competent data-protection authority.",
      ],
    },
  },
  {
...
export default function PrivacyPage() {
  ...
  const t = {
    fr: {
      ...
      intro:
        "Chez Fanienne, vos données personnelles sont traitées avec sérieux. Cette page explique quelles informations nous collectons, pourquoi, et quels sont vos droits.",
    ...
    en: {
      ...
      intro:
        "At Fanienne, your personal data is handled carefully. This page explains what information we collect, why, and what your rights are.",
